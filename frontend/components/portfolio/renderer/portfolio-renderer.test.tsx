...
describe("PortfolioRenderer", () => {
  ...
  it("supports a temporary template and theme override without changing portfolio data", () => { render(<PortfolioRenderer portfolio={portfolio} templateOverride="creative" themeOverride={{ primaryColor: "#123456" }}/>); const root = document.querySelector('[data-template="creative"]'); expect(root).toBeInTheDocument(); expect(root).toHaveStyle({ "--portfolio-primary": "#123456" }); expect(portfolio.templateKey).toBe("minimal"); });
