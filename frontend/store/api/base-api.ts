...
export const baseApi = createApi({ reducerPath: "api", baseQuery: authenticatedBaseQuery, tagTypes: ["Portfolio", "PortfolioCompleteness", "PortfolioDesign", "PortfolioSections", "PortfolioPreview", "Profile", "Experience", "Education", "Skill", "Project", "Resume", "ResumePreview"], endpoints: () => ({}) });
